...
namespace BTN_QLIVETAU
{
    public partial class frm_QuanLyTau : Form
    {
            ...
            if (dgvTau.SelectedRows.Count > 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        kn.ThucThi(sql_xoa);
                        this.tAUTableAdapter.Fill(this.qLI_VETAUDataSet4.TAU);
        ...
        {
            // TODO: This line of code loads data into the 'qLI_VETAUDataSet4.TAU' table. You can move, or remove it, as needed.
            this.tAUTableAdapter.Fill(this.qLI_VETAUDataSet4.TAU);
            Hienthi();
        ...
        private void dgvTau_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
