...
namespace BTN_QLIVETAU
{
    public partial class frm_QuanLyLichTrinh : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLI_VETAUDataSet3.LICHTRINH' table. You can move, or remove it, as needed.
            this.lICHTRINHTableAdapter.Fill(this.qLI_VETAUDataSet3.LICHTRINH);
            HienThiDuLieu();
            LoadGaToComboBox();
        ...
        private void bttn_LamMoi_Click_1(object sender, EventArgs e)
        {
